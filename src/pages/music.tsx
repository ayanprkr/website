            ...
            <div className="py-10 md:py-20 flex flex-col justify-center items-start gap-5">
                ...
                <div className="w-full grid grid-cols-2 md:grid-cols-3 gap-5">
                    {topTracks?.map((track: any, index: number) => (
                        <div key={index} className="cursor-default w-full flex flex-col items-start justify-center bg-neutral-900 border-neutral-800 hover:border-neutral-500 border-2 font-bold text-gray-400 rounded-lg p-5 transiton duration-300">
